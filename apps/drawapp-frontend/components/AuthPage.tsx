    ...
    <div className="min-h-screen flex items-center justify-center bg-black relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md p-8 rounded-2xl bg-neutral-900 shadow-xl border border-neutral-800">
        ...
        <form className="space-y-5">
          ...
          <button type="submit" className="w-full py-3 rounded-lg bg-gradient-to-b from-gray-700 to-gray-900 text-white font-medium hover:opacity-90 transition" > {isSignin ? "Sign in" : "Sign up"} </button>
        </form>
      </div>
    </div>
  );
